...
!        call system('ls' ) ! Linux
        ...
        do
            ...
            case ('SFE', 'sfe')
                ...
                loads(np, 1) = 2 		! load type
                loads(np, 2) = ivalue	! element
                loads(np, 3) = ivalue2	! face
                loads(np, 4) = rvalue	! pressure
            case ('ACEL', 'acel')
                backspace (10)
...
!    
    subroutine stopwatch(oper)
        ...
        case ('STOP', 'stop')
            ...
            write (6, '(8x, 1a, 1f16.7)') 'elapsed wall clock time:', finish_time - start_time
        case default
